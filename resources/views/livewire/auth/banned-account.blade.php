    ...
    <div class="w-full max-w-2xl">
        ...
        <div class="bg-white/20 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/30 p-8 mb-6">
            <div class="text-center mb-8">
                <!-- Banned Icon -->
                <div class="inline-flex items-center justify-center w-20 h-20 bg-red-500/20 backdrop-blur-xl rounded-full mb-4">
                    <svg class="w-10 h-10 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636"/>
                    </svg>
                </div>
                
                <h1 class="text-3xl font-bold text-[#231F20] mb-2">Account Banned</h1>
                <p class="text-[#9B9EA4] text-lg">Your account has been permanently banned from the KeNHAVATE Innovation Portal.</p>
            </div>

            <div class="bg-red-50/50 backdrop-blur-xl border border-red-200/50 rounded-2xl p-6 mb-8">
                <h3 class="text-lg font-semibold text-red-800 mb-2">Account Status</h3>
                <p class="text-red-700">
                    Your account has been banned due to violations of our community guidelines or terms of service. 
                    This means you cannot access the KeNHAVATE Innovation Portal or submit ideas and challenges.
                </p>
            </div>
        </div>
