...
<div class="flex flex-col space-y-6">
    ...
    <div class="bg-[#F8EBD5] border border-[#FFF200] rounded-xl p-6">
        <div class="flex items-center mb-3">
            ...
            <div class="ml-3">
                <h3 class="text-lg font-semibold text-[#231F20]">Email Verification Required</h3>
            </div>
        </div>
        <p class="text-[#231F20]">
    ...
    @if (session('status') == 'verification-link-sent')
        <div class="bg-[#F8EBD5] border border-[#FFF200] rounded-xl p-4">
            <div class="flex items-center">
                ...
                <p class="text-[#231F20] text-sm font-medium">
    ...
    <div class="flex flex-col space-y-4">
        ...
        <button 
            wire:click="logout" 
            class="w-full bg-[#9B9EA4] hover:bg-[#231F20] text-white font-semibold py-3 px-6 rounded-xl transition-colors duration-200"
        >
            Log Out
        </button>
    </div>
    ...
    <div class="text-center">
        <p class="text-sm text-[#9B9EA4]">
            ...
            <a href="mailto:support@kenha.co.ke" class="font-medium text-[#FFF200] hover:text-[#FFF200]/80 transition-colors duration-200">
                support@kenha.co.ke
            </a>
        </p>
    </div>
