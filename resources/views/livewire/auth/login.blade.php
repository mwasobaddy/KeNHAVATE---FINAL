...
<div class="space-y-6">
    ...
    @if (!$showOtpForm)
        ...
        <form wire:submit="sendOTP" class="space-y-6">
            ...
            <!-- Submit Button -->
            <div class="space-y-4">
                <flux:button variant="primary" type="submit" class="w-full justify-center rounded-lg bg-blue-600 px-4 py-3 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600">
                ...
                <flux:button variant="outline" type="button" class="w-full justify-center rounded-lg border border-gray-300 bg-white px-4 py-3 text-sm font-semibold text-gray-900 shadow-sm hover:bg-gray-50">
            ...
            @if ($otpMessage)
                <div class="rounded-lg bg-green-50 p-4 border border-green-200">
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <p class="text-sm font-medium text-green-800">{{ $otpMessage }}</p>
                        </div>
                    </div>
                </div>
            @endif
            ...
            <form wire:submit="verifyOTP" class="space-y-6">
                ...
                <div>
                    <flux:input
                        ...
                        maxlength="6"
                        pattern="[0-9]{6}"
                        class="text-center text-2xl tracking-[0.5em] font-mono block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                    />
                    <p class="mt-2 text-sm text-gray-600">Enter the 6-digit code sent to <span class="font-medium">{{ $email }}</span></p>
                </div>
                        ...
                        @if ($resendCooldown > 0)
                            <span class="text-sm text-gray-500">
                                Resend in <span x-data="{ countdown: @entangle('resendCooldown') }" 
                                    ...
                                    " 
                                    x-text="countdown"
                                    class="font-medium text-blue-600">{{ $resendCooldown }}</span>s
                            </span>
                        @else
                            <flux:button 
    ...
    @if (Route::has('register'))
        <div class="text-center border-t border-gray-200 pt-6">
            <p class="text-sm text-gray-600">
                ...
                <flux:link :href="route('register')" wire:navigate class="font-medium text-blue-600 hover:text-blue-500">Sign up for free</flux:link>
            </p>
        </div>
    @endif
</div>
