...
<div class="flex flex-col space-y-6">
    ...
    <form wire:submit="resetPassword" class="space-y-6">
        <!-- Email Address -->
        <div>
            <label for="email" class="block text-sm font-medium text-[#231F20] mb-2">
        ...
        <!-- Confirm Password -->
        <div>
            <label for="password_confirmation" class="block text-sm font-medium text-[#231F20] mb-2">
    ...
    <div class="text-center">
        <p class="text-sm text-[#9B9EA4]">
            ...
            <a href="{{ route('login') }}" wire:navigate class="font-medium text-[#FFF200] hover:text-[#FFF200]/80 transition-colors duration-200">
                Sign in here
            </a>
        </p>
    </div>
