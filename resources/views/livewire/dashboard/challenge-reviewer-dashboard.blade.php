        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
            <div class="lg:col-span-2">
                <div class="group relative overflow-hidden rounded-3xl bg-white/70 dark:bg-zinc-800/70 backdrop-blur-xl border border-white/20 dark:border-zinc-700/50 shadow-xl p-6">
                    <div class="absolute inset-0 bg-gradient-to-r from-purple-500/5 via-transparent to-purple-400/10"></div>
                    <div class="relative">
                        <h3 class="font-semibold text-gray-900 dark:text-white mb-4">Gamification Hub</h3>
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                            ...
                            <a href="{{ route('gamification.leaderboard') }}" class="group/card relative overflow-hidden rounded-xl bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 border border-blue-200 dark:border-blue-700/50 p-4 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
                                ...
                                <p class="text-blue-700 dark:text-blue-300 text-xs mt-1">Reviewer Rankings</p>
                            </a>
            ...
            <div class="lg:col-span-1">
                <div class="group relative overflow-hidden rounded-3xl bg-white/70 dark:bg-zinc-800/70 backdrop-blur-xl border border-white/20 dark:border-zinc-700/50 shadow-xl p-6">
                    <div class="absolute inset-0 bg-gradient-to-r from-orange-500/5 via-transparent to-orange-400/10"></div>
                    <div class="relative">
                        <h3 class="font-semibold text-gray-900 dark:text-white mb-4">Reviewer Performance</h3>
                        <div class="space-y-3">
                            ...
                            <div class="flex justify-between items-center">
                                <span class="text-sm text-gray-600 dark:text-gray-400">Reviewer Rank</span>
                                <span class="font-semibold text-gray-900 dark:text-white">#{{ $this->reviewerRank ?? '--' }}</span>
                            </div>
                            <div class="flex justify-between items-center">
                                <span class="text-sm text-gray-600 dark:text-gray-400">Challenges Reviewed</span>
                                <span class="font-semibold text-gray-900 dark:text-white">{{ $this->challengesReviewed ?? 0 }}</span>
                            </div>
                            <div class="flex justify-between items-center">
                                <span class="text-sm text-gray-600 dark:text-gray-400">Average Score</span>
                                <span class="font-semibold text-gray-900 dark:text-white">{{ number_format($this->averageScore ?? 0, 1) }}/5</span>
                            </div>
                        </div>
                    </div>
                </div>
